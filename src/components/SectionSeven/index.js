...
const SectionSeven = () => {
  return (
    ...
    <SectionSevenContainer>
        ...
        <SectionSevenHeadertext><p>We are here for you</p></SectionSevenHeadertext>
        
        <LocationWrapper>
        <ColumnOneIcons><FaMapMarkerAlt/> </ColumnOneIcons>
          Nigeria Reinsurance Building, Zakaria <br></br>
          Maimalari St, Central Business District, Abuja</LocationWrapper>
        ...
        <SectionSevenForms>
          ...
          <FormError><p>An Error Occured</p></FormError>
